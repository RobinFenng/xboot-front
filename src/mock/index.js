...
import { getMessageInit, getContentByMsgId, hasRead, removeReaded, restoreTrash, messageCoun, getUserData } from './user'
...
Mock.mock(/\/xboot\/user\/info/, getUserData)
Mock.mock(/\/user\/info/, getUserData)
//Mock.mock(/\/login/, login)
